...
# Cache the image for node debug purpose
tool_image=$(${OC} --kubeconfig=$1/auth/kubeconfig adm release info --image-for=tools)
${SSH} core@api.${CRC_VM_NAME}.${BASE_DOMAIN} -- sudo crictl pull ${tool_image}
